package com.malikjayendria.simpleapi.Controller;


import com.malikjayendria.simpleapi.Entity.Product;
import com.malikjayendria.simpleapi.Service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<Product> saveProduct(@RequestBody Product product) {
        Product newProduct = productService.saveProduct(product).getBody();
